    ...
    <div className="min-h-screen bg-gradient-to-br from-bgLight via-harmony-teal/10 to-harmony-violet/10 transition-all">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
         ...
         <Link to="/reels">
          <div className="bg-pink-400 rounded-2xl  p-8 hover:shadow-glow transition-all duration-300">
            <div className="text-5xl mb-4">🎬</div>
            <h3 className="text-2xl font-bold text-textDark mb-2">
              Daily Reels
            </h3>
            <p className="text-textDark mb-4">Learn Effortlessly</p>
            <div className="inline-block bg-green-600 text-white px-6 py-2 rounded-lg font-medium cursor-not-allowed">
              Watch Reels
            </div>
          </div>
         </Link>
